  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="fixed top-[8%] left-1/2 transform -translate-x-1/2 z-[10001] p-0 border-border bg-card overflow-hidden w-[95vw] sm:w-[95vw] max-w-6xl max-h-[84vh] sm:rounded-lg">
