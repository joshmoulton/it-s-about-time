...
export function FeedbackModal({ isOpen, onClose }: FeedbackModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-lg max-h-[85vh] overflow-y-auto bg-slate-900 border-slate-700 text-white data-[state=open]:translate-y-[-50%] sm:data-[state=open]:translate-y-[-50%]">
