...
export function TopicSelector({ selectedTopic, onTopicChange }: TopicSelectorProps) {
  ...
  return (
    <Select value={selectedTopic || 'Money Glitch'} onValueChange={(value) => onTopicChange(value)}>
      ...
      <SelectContent className="z-[99999] bg-slate-800 border-slate-700 text-white backdrop-blur-sm shadow-xl min-w-[160px]" position="popper" sideOffset={8} align="start" avoidCollisions={true} collisionPadding={10}>
