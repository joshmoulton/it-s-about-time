  ...
  return <div className="space-y-6">
      ...
      <Card className="border border-brand-navy/20 bg-brand-navy/5 shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Available authentication methods for your account
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {isWhopUser ? 'Not available for Whop accounts' : 'Standard login method'}
                  </p>
                </div>
              </div>
              <Badge variant={isWhopUser ? 'secondary' : 'default'}>
                {isWhopUser ? 'Disabled' : 'Enabled'}
              </Badge>
            </div>
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {isWhopUser ? 'Not available for Whop accounts' : 'Passwordless email login'}
                  </p>
                </div>
              </div>
              <Badge variant={isWhopUser ? 'secondary' : 'default'}>
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">Whop OAuth</p>
                  <p className="text-sm text-muted-foreground">
                    {isWhopUser ? 'Your primary login method' : 'Available after upgrading'}
                  </p>
                </div>
              </div>
              <Badge variant={isWhopUser ? 'default' : 'secondary'}>
                {isWhopUser ? 'Active' : 'Available'}
              </Badge>
            </div>
          </div>

          {!isWhopUser && <div className="mt-4 pt-4 border-t">
              <p className="text-sm text-muted-foreground mb-3">
                Upgrade to a premium plan to access Whop authentication and enhanced security features.
              </p>
