...
const TICKER_TO_COINGECKO_ID: Record<string, string> = {
  ...
  // Popular meme/alt coins (Top 100 from CoinGecko meme category)
  'DOGE': 'dogecoin',
  'SHIB': 'shiba-inu',
  'PEPE': 'pepe',
  'FLOKI': 'floki',
  ...
  'FLOKICEO': 'floki-ceo',
  'MEME': 'memecoin',
  'MAGA2': 'make-america-great-again-2',
  ...
  'HOPPY': 'hoppy',
  'MANEKI': 'maneki',
  'MUMU2': 'mumu-the-bull-2',
  'SOLAMA': 'solama',
  'EPIK': 'epik-prime',
  'RIFAMPICIN': 'rifampicin',
  'DOLAND': 'doland-tremp',
  'DUCK': 'ducky',
  'SMOL': 'smiling-dolphin',
  'PORK': 'pork-2',
  'HODL': 'hodl-token',
