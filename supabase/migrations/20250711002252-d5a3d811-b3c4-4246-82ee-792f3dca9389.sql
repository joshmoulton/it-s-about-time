-- Phase 5: Advanced Data Encryption & Security Hardening
...
CREATE POLICY "Super admins can view encrypted data with logging"
ON public.encrypted_user_data
FOR SELECT
USING (
    has_admin_role('super_admin') 
    AND require_secure_data_access('encrypted_data_view')
);
