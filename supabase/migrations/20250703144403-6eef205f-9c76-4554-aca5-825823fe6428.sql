...
CREATE POLICY "Only admins can insert video tutorials" 
ON public.video_tutorials 
FOR INSERT 
WITH CHECK (
  EXISTS (
...
CREATE POLICY "Only admins can update video tutorials" 
ON public.video_tutorials 
FOR UPDATE 
USING (
  EXISTS (
...
CREATE POLICY "Only admins can delete video tutorials" 
ON public.video_tutorials 
FOR DELETE 
USING (
  EXISTS (
