-- AUTOMATED SECURITY MONITORING: Set up cron jobs for continuous security monitoring
...
-- Create a view for security dashboard monitoring
CREATE OR REPLACE VIEW public.security_dashboard AS
SELECT 
  'security_status' as metric_type,
  jsonb_build_object(
    'timestamp', now(),
...
-- Grant access to security dashboard for super admins only
CREATE POLICY "security_dashboard_super_admin_access" 
