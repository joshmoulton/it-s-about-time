-- Fix telegram_messages RLS policies - The table has RLS enabled but no policies!
-- This is causing all queries to fail with 500 errors due to statement timeouts
