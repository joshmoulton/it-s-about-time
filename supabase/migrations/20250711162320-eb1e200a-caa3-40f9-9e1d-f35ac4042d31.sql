-- Final Performance Optimization: Clean up storage policies, remove unused indexes, and fix remaining policy conflicts (Fixed Version)
...
-- ==============================================
-- PHASE 2: UNUSED INDEXES AND CONSTRAINTS CLEANUP
-- ==============================================

-- Remove constraints first, then indexes
ALTER TABLE public.subscription_tiers DROP CONSTRAINT IF EXISTS subscription_tiers_tier_key;
ALTER TABLE public.admin_feed_controls DROP CONSTRAINT IF EXISTS admin_feed_controls_section_name_key;
